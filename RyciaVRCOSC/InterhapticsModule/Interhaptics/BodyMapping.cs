...
namespace Interhaptics.HapticBodyMapping
{
    ...
    public enum EProtocol /// Definition of the different protocols supported by the Interhaptics Engine
    {
        UnknownProtocol = -1,
        PCM = 0,
        Clips = 1,
    ...
    public enum Perception /// Enumeration for different types of haptic perceptions.
    {
	...
	public enum BufferDataType /// Enumeration for types of haptic buffer data.
    {
	...
	public enum BodyPartID /// Enumeration for identifying different body parts for haptic effects.
    {
	...
	public enum Operator /// Enumeration for operator signs in haptic command data.
    {
        Minus = -1,
        Neutral = 0,
        Plus = 1,
	...
	public enum LateralFlag /// Enumeration for lateral flag in haptic command data.
    {
        Unknown_position = -1,
        Global = 0,
        Right = 1,
	...
	public enum GroupID /// Enumeration for group identification in haptic command data.
    {
        Unknown = -1,
	...
	public struct CommandData /// Structure for command data in haptic systems.
    {
        ...
        public Operator Sign; /// Sign of the operation (+/-)                  
        public GroupID Group; /// Targeted group.
        public LateralFlag Side; /// Targeted side.
    };
}